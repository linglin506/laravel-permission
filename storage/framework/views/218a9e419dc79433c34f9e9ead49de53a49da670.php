...
<div class="layui-form" lay-filter="layuiadmin-form-permission" id="layuiadmin-form-permission"
                ...
                <?php $__empty_1 = true; $__currentLoopData = $permissions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $perm): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    ...
                    <?php if(isset($perm['_child'])): ?>
                        <?php $__currentLoopData = $perm['_child']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $childs): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option value="<?php echo e($childs['id']); ?>" <?php echo e(isset($permission->id) && $childs['id'] == $permission->parent_id ? 'selected' : ''); ?> >
                                &nbsp;&nbsp;|--<?php echo e($childs['display_name']); ?></option>
                            <?php if(isset($childs['_child'])): ?>
                                <?php $__currentLoopData = $childs['_child']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $lastChilds): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($lastChilds['id']); ?>" <?php echo e(isset($permission->id) && $lastChilds['id'] == $permission->parent_id ? 'selected' : ''); ?> >
                                        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;|--<?php echo e($lastChilds['display_name']); ?></option>
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-block">
            <input type="text" name="name" value="<?php echo e($permission->name); ?>" lay-verify="required" class="layui-input"
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-block">
            <input type="text" name="display_name" value="<?php echo e($permission->display_name); ?>" lay-verify="required"
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-block">
            <input class="layui-input" type="text" name="route" value="<?php echo e($permission->route); ?>"
