...
<body>
  ...
  <div class="layui-form" lay-filter="layuiadmin-form" id="layuiadmin-form" style="padding: 20px 30px 0 0;">
    ...
    <div class="layui-form-item">
      ...
      <div class="layui-input-block">
        <input type="text" name="domain" value="<?php echo e($organization->domain??old('domain')); ?>" lay-verify="required" class="layui-input" placeholder="">
      </div>
    </div>
    ...
    <div class="layui-form-item">
      ...
      <div class="layui-input-block">
        <input class="layui-input" type="text" name="ip" value="<?php echo e($organization->ip??old('ip')); ?>" lay-verify="required" placeholder="" >
      </div>
    </div>
    ...
    <div class="layui-form-item">
      ...
      <div class="layui-input-block">
        <input class="layui-input" type="text" name="contact" value="<?php echo e($organization->contact??old('contact')); ?>" lay-verify="required" placeholder="" >
      </div>
    </div>
    ...
    <div class="layui-form-item">
      ...
      <div class="layui-input-block">
        <input class="layui-input" type="text" name="contact_phone" value="<?php echo e($organization->contact_phone??old('contact_phone')); ?>" lay-verify="required" placeholder="" >
      </div>
    </div>
    ...
    <div class="layui-form-item">
      ...
      <div class="layui-input-block">
        <input class="layui-input" type="text" lay-verify="email" name="contact_email" value="<?php echo e($organization->contact_email??old('contact_email')); ?>" placeholder="" >
      </div>
    </div>
