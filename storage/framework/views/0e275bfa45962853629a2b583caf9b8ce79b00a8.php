...
<div class="layui-form" lay-filter="layuiadmin-form" id="layuiadmin-form" style="padding: 20px 30px 0 0;">
        ...
        <div class="layui-input-block">
            <select name="uid" lay-filter="LAY-report-type" lay-search>
                <?php $__currentLoopData = $users; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $user): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <?php if($organization->uid == $user->id): ?>
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-block">
            <input type="text" name="name" value="<?php echo e($organization->name); ?>" lay-verify="required"
        ...
        <div class="layui-input-block">
            <select name="type_id" lay-filter="LAY-report-type">
                <?php $__currentLoopData = $types; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $type): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <?php if($organization->type_id == $type->id): ?>
        ...
        <div class="layui-input-block">
            <select name="industry_id" lay-filter="LAY-report-type">
                <?php $__currentLoopData = $industries; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $industry): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <?php if($organization->industry_id == $industry->id): ?>
                        <option value="<?php echo e($industry ->id); ?>" selected><?php echo e($industry ->industry); ?></option>
                    <?php else: ?>
    ...
    <div class="layui-form-item" id="area-picker">
        ...
        <div class="layui-input-block">
            <div class="layui-input-inline" style="width: 200px;">
                <select name="province" class="province-selector" data-value="<?php echo e($organization->province); ?>"
                        lay-filter="province-1">
                    <option value="">请选择省</option>
                </select>
            </div>
            <div class="layui-input-inline" style="width: 200px;">
                <select name="city" class="city-selector" data-value="<?php echo e($organization->city); ?>" lay-filter="city-1">
                    <option value="">请选择市</option>
                </select>
            </div>
            <div class="layui-input-inline" style="width: 200px;">
                <select name="district" class="county-selector" data-value="<?php echo e($organization->district); ?>"
                        lay-filter="county-1">
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-block">
            <input class="layui-input" type="text" name="address" value="<?php echo e($organization->address); ?>"
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-block">
            <input class="layui-input" type="text" name="contact"
                   value="<?php echo e($organization->address); ?>" lay-verify="required" placeholder="">
        </div>
    </div>
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-block">
            <input class="layui-input" type="text" name="phone"
                   value="<?php echo e($organization->phone); ?>" lay-verify="required" placeholder="">
        </div>
    </div>
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-block">
            <input class="layui-input" type="text" name="mobile"
                   value="<?php echo e($organization->mobile); ?>" placeholder="" lay-verify="phone">
        </div>
    </div>
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-block">
            <input class="layui-input" type="text" name="fax"
                   value="<?php echo e($organization->fax); ?>" placeholder="">
        </div>
    </div>
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-block">
            <input class="layui-input" type="text" lay-verify="required|email" name="email"
                   value="<?php echo e($organization->email); ?>" placeholder="">
        </div>
    </div>
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-block">
            <input class="layui-input" type="text" name="ip"
                   value="<?php echo e($organization->ip); ?>" placeholder="" lay-verify="ip">
        </div>
    </div>
